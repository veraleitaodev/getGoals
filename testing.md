...
####    Navigation bar
-   ***mobile view*** - the navigation bar presents logo with link to home page, hover effect working; 
...
-   ***desktop view*** - the navigation bar presents logo with link to home page and hover effects, also presents links on the right side, to the different pages, hover effect is also functional;  
...
####    Footer
-   ***mobile view*** - footer appears in every page and is fixed to the bottom of the page as intended;  
...
-   ***desktop view*** - footer appears in every page and is fixed to the bottom of the page as intended;  
    the footer thas two rows:
